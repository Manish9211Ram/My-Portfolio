              ...
              {bootcamps.map((bootcamp, index) => (
                ...
                >
                  <CardContent className="p-5">
                    ...
                    <p className="text-gray-200 text-sm">{bootcamp.focus}</p>
                  </CardContent>
                </Card>
              ))}
            </div>
              ...
              <CardContent className="p-6">
                ...
                <div className="grid grid-cols-2 gap-4 text-center">
                  <div>
                    ...
                    <div className="text-gray-200 text-sm">Bootcamps Completed</div>
                  </div>
                  <div>
                    <div className="text-2xl font-bold text-blue-400">100+</div>
                    <div className="text-gray-200 text-sm">Hours of Training</div>
                  </div>
                </div>
              </CardContent>
            </Card>
